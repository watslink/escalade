    ...
    <table class="table table-striped sortTable">
        ...
        <c:forEach items="${utilisateurConnecte.listTopoAPreter}" var="topoAPreter">
            <tr>
                ...
                <td>
                    <a href="mailto:${topoAPreter.utilisateurEmprunteur.mail}">${topoAPreter.utilisateurEmprunteur.pseudo}</a>
                </td>
                ...
                <td>
                    ...
                    <a data-confirm="Confirmer la suppression?"
                       href="${pageContext.request.contextPath}/removeFromMy_topos?topoAPreter_id=${topoAPreter.utilisateur_topos_id}"
