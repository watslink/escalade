...
<h4> Département: <a
        href="${pageContext.request.contextPath}/liste_sites_par_departement?code_departement=${voie.secteur.site.departement.code}"> ${voie.secteur.site.departement.nom} ${voie.secteur.site.departement.code}</a>
    /
    Ville: ${voie.secteur.site.ville.nom} /
    Site: <a
            href="${pageContext.request.contextPath}/liste_secteurs?site_id=${voie.secteur.site.site_id}"> ${voie.secteur.site.nom}</a>
    /
    ...
    <table id="table" class="table table-striped sortTable">
        ...
        <c:forEach items="${voie.listLongueur}" var="longueur">
            <tr>
                ...
                <td><a data-confirm="Confirmer la suppression?"
                       href="${pageContext.request.contextPath}/supprimer_longueur?longueur_id=${longueur.longueur_id}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form:form class="form-horizontal text-center" action="ajouter_longueur" method="post"
                               modelAttribute="longueur">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="numero">Numéro</label>
                                <div class="col-md-4">
                                    <form:input id="numero" path="numero" type="number" placeholder=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <form:input id="hauteur" path="hauteur" type="number" placeholder=""
                                                class="form-control input-md" required="true"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <form:input id="nombre_points" path="nombre_points" type="number" placeholder=""
                                                class="form-control input-md" required="true"/>
                                </div>
                            </div>
        ...
        <div class="row col-xs-offset-2 col-xs-8">
            <form:form action="details_voie" method="post" modelAttribute="commentaire">
                <div class="lg-form amber-textarea active-amber-textarea">
                    <textarea id="formComm" name="commentaire" class="md-textarea form-control" rows="3"
